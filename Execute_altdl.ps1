...
py D:/College/Projects/zippyshare-dl/altdl.py | tee -a D:/College/Projects/zippyshare-dl/Logs/log_altdl.txt
subl D:/College/Projects/zippyshare-dl/Logs/log_altdl.txt
deactivate
